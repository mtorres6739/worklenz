...
// Keep restored schemas compatible with application rollbacks. The import worker can
// remain disabled on older application images without dropping queued or staged data.
exports.down = (pgm) => {
  pgm.sql("SELECT 1");
};
