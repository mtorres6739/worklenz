...
projectMembersApiRouter.post("/invite", invitationLimiter, teamOwnerOrAdminValidator, projectMemberInviteValidator, safeControllerFunction(ProjectMembersController.createByEmail));
...
projectMembersApiRouter.post("/invitation-link", invitationLimiter, teamOwnerOrAdminValidator, safeControllerFunction(ProjectMembersController.generateProjectInvitationLink));
